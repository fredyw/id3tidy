...
import org.fredy.id3tidy.util.VersionUtils;
...
public class ID3TidyFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        setTitle(String.format(rb.getString(ResourceBundleKey.LABEL_APPLICATION.toString()),
            rb.getString(ResourceBundleKey.VERSION.toString())));
    ...
    class FileNamePatternPanel extends JPanel {
        ...
        private void initComponents() {
            ...
            // There must be at least one combo box.
            JComboBox<ID3TagEnum> tagsComboBox = new JComboBox<ID3TagEnum>(ID3TagEnum.values());
            ...
            addPatternButton = new JButton(rb.getString(ResourceBundleKey.BUTTON_ADD_PATTERN
                    .toString()));
            ...
            removePatternButton = new JButton(rb.getString(ResourceBundleKey.BUTTON_REMOVE_PATTERN
                    .toString()));
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            try {
                                ...
                                ID3Tidy.update(fileListPanel.getFiles(), parts, overwriteCheckBox
                                        .isSelected());
            ...
            overwriteCheckBox = new JCheckBox(rb.getString(ResourceBundleKey.LABEL_OVERWRITE
                    .toString()));
        ...
        private void addPattern(LinkedList<JComponent> patterns, JPanel panel) {
            ...
            JComboBox<ID3TagEnum> tagsComboxBox = new JComboBox<ID3TagEnum>(ID3TagEnum.values());
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            try {
                                ...
                                ID3Tidy.update(fileListPanel.getSelectedFile(), tag, 
        ...
        private void initComponents() {
            ...
            fileChooser.setFileFilter(new FileFilter() {
                ...
                public String getDescription() {
                    return rb.getString(ResourceBundleKey.FILECHOOSER_ID3TIDY_SUPPORTED_FILES
                            .toString());
                }
                ...
                public boolean accept(File f) {
                    ...
                    if (f.getName().toLowerCase().endsWith(MP3_EXTENSION) 
                        || f.getName().toLowerCase().endsWith(M3U_EXTENSION)) {
                        return true;
                    }
                    return false;
                }
...
;        }
    ...
    class PlaylistPanel extends JPanel {
        ...
        private void initComponents() {
            ...
            absolutePathRadioButton = new JRadioButton(
                    rb.getString(ResourceBundleKey.RADIO_BUTTON_ABSOLUTE_PATH.toString()));
            absolutePathRadioButton.setSelected(true);
            buttonGroup.add(absolutePathRadioButton);
            panel1.add(absolutePathRadioButton);
            relativePathRadioButton = new JRadioButton(
                    rb.getString(ResourceBundleKey.RADIO_BUTTON_RELATIVE_PATH.toString()));
            buttonGroup.add(relativePathRadioButton);
            panel1.add(relativePathRadioButton);
            
            JPanel panel2 = new JPanel(new MigLayout());
            panel2.setBorder(BorderFactory.createEtchedBorder());
            createButton = new JButton(rb.getString(ResourceBundleKey.BUTTON_CREATE
                    .toString()));
            createButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        @Override
                        protected Void doInBackground() throws Exception {
                            ID3Tidy.createM3UFile(fileListPanel.getFiles(), new File(
                                    saveToTextField.getText()), absolutePathRadioButton
                                    .isSelected());
                            return null;
                        }
    ...
    class CreatedByPanel extends JPanel {
        ...
        public CreatedByPanel() {
            checkForUpdateButton = new JButton(rb.getString(
                ResourceBundleKey.BUTTON_CHECK_FOR_UPDATE.toString()));
            checkForUpdateButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    try {
                        ...
                        String currentVersion = rb.getString(ResourceBundleKey.VERSION.toString());
                        int comparison = VersionUtils.compare(currentVersion, latestVersion);
                        if (comparison == 0) {
                            message = String.format(
                                rb.getString(ResourceBundleKey.INFO_LATEST_VERSION.toString()),
                                currentVersion);
                        } else if (comparison == -1) {
                            message = String.format(
                                rb.getString(ResourceBundleKey.INFO_NEW_VERSION.toString()),
                                latestVersion);
                        } else {
                            // this is actually a weird case, so just ignore it
                            message = String.format(
                                rb.getString(ResourceBundleKey.INFO_LATEST_VERSION.toString()),
                                currentVersion);
                        }
                        JOptionPane.showMessageDialog(ID3TidyFrame.this, message, 
                            rb.getString(ResourceBundleKey.INFO_CHECK_FOR_UPDATE.toString()),
                            JOptionPane.INFORMATION_MESSAGE);
                    } catch (ID3TidyVersionException e) {
                        message = "Unable to get the latest version";
                        JOptionPane.showMessageDialog(ID3TidyFrame.this, message,
                            rb.getString(ResourceBundleKey.INFO_CHECK_FOR_UPDATE.toString()),
